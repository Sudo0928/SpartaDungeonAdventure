...
namespace GenshinImpactMovementSystem
{
    public class PlayerMovementState : IState
    {
        ...
        private void Move()
        {
            if (stateMachine.Player.RigidbodyReciver.force != Vector3.zero)
            {
                stateMachine.ChangeState(stateMachine.FallingState);

                stateMachine.Player.Rigidbody.AddForce(stateMachine.Player.RigidbodyReciver.force, stateMachine.Player.RigidbodyReciver.forceMode);

                stateMachine.Player.RigidbodyReciver.force = Vector3.zero;
        ...
        private void UpdateTargetRotatoinData(float targetAngle)
        {
        ...
        protected void RotateTowardsTargetRotatoin()
        {
        ...
        protected float UpdateTargetRotation(Vector3 direction, bool shouldConsiderCameraRotation = true)
        {
            ...
            {
                UpdateTargetRotatoinData(directionAngle);
            }
